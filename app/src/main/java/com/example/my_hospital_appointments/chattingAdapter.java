...
private ArrayList<String> message=new ArrayList<>();
    ...
    public chattingAdapter(ArrayList<String> myMessage)
    {
         message=myMessage;
    }
    ...
    public int getItemViewType(int position) {   //we use the getItemViewType method to get the view to use in the recycle Viewer
        ...
        if(message.get(position).contains("Sent_")) //IF in the arraylist the text has the words "Sent_" we know its from
